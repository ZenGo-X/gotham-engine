...
pub async fn wrap_keygen_first(
    ...
    info!("/ecdsa/keygen_v2/first | {:?}", claim);
    struct Gotham {}
...
pub async fn wrap_keygen_second(
    ...
    info!("/ecdsa/keygen_v2/{}/second | {:?}", id, claim);
    struct Gotham {}
    impl KeyGen for Gotham {}
...
pub async fn wrap_keygen_third(
    ...
    info!("/ecdsa/keygen_v2/{}/third | {:?}", id, claim);
...
pub async fn wrap_keygen_fourth(
    ...
    info!("/ecdsa/keygen_v2/{}/fourth | {:?}", id, claim);
...
pub async fn wrap_chain_code_first_message(
    ...
    info!("/ecdsa/keygen_v2/{}/chaincode/first | {:?}", id, claim);
...
pub async fn wrap_chain_code_second_message(
    ...
    info!("/ecdsa/keygen_v2/{}/chaincode/second | {:?}", id, claim);
...
pub async fn wrap_sign_first(
    ...
    info!("/ecdsa/sign/{}/first | {:?}", id, claim);
...
pub async fn wrap_sign_second(
    ...
    info!("/ecdsa/sign/{}/second | {:?}", id, claim);
...
pub async fn wrap_sign_first_v2(
    ...
    info!("/ecdsa/sign/{}/first_v2 | {:?}", id, claim);
...
pub async fn wrap_sign_second_v2(
    ...
    info!("/ecdsa/sign/{}/second_v2 | {:?}", ssid, claim);
...
pub async fn wrap_sign_first_v3(
    ...
    info!("/ecdsa/sign/{}/first_v3 | {:?}", id, claim);
...
pub async fn wrap_sign_second_v3(
    ...
    info!("/ecdsa/sign/{}/second_v3 | {:?}", ssid, claim);
