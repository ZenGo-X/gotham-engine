...
impl EcdsaStruct {
    fn to_struct_name(&self) -> String {
        let res = match self {
            ...
            EcdsaStruct::Party2Public => "Party2Public",
            ...
            EcdsaStruct::CCCommWitness => "CommWitness",
            EcdsaStruct::CCEcKeyPair => "EcKeyPair",
            EcdsaStruct::CC => "CC",
            EcdsaStruct::Party1MasterKey => "Party1MasterKey",
